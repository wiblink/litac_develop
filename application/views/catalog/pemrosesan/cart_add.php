           ...
           <div class="col-12">
			...
			<div class="form-group mb-3 row">
                <label class="form-label col-3 col-form-label">Gears</label>
					<div class="col">
					  <input type="text" name="gears" id="gears" class="form-control" value="" placeholder="Gears">
					</div>
            </div>
			<div class="form-group mb-3 row">
			...
			<div class="form-group mb-3 row">
                <label class="form-label col-3 col-form-label">Tilt / Rotation (Deg)</label>
					<div class="col">
					  <input type="text" name="tilt" id="tilt" class="form-control" value="" placeholder="Tilt" size=4 maxlength=5>
					</div>
					<div class="col">
					  <input type="text" name="rotation" id="rotation" class="form-control" value="" placeholder="Rotation" size=4 maxlength=5>
					</div>
            </div>
			<hr>
			<!--<div class="form-group mb-3 row">
			...
			<div class="form-group mb-3 row">
                <label class="form-label col-3 col-form-label">Voltage (V)</label>
					<div class="col">
					  <input type="text" name="voltage" id="voltage" class="form-control" value="" placeholder="Voltage" size=4 maxlength=5>
					</div>
            </div>
			<div class="form-group mb-3 row">
			...
			<div class="form-group mb-3 row">
				<label class="form-label col-3 col-form-label">Beam Angle</label>
					<div class="col">
					 ...
					 &nbsp;
						<input type="text" name="beam_angle2" id="beam_angle2" class="form-control" value="" placeholder="Beam" size=4 maxlength=5>
					</div>
			</div>			
			...
			<div class="form-group mb-3 row">
                <label class="form-label col-3 col-form-label">IP</label>
					<div class="col">
					  <input type="text" name="tecspec_ip" id="tecspec_ip" class="form-control" value="" placeholder="IP" size=4 maxlength=5>
					</div>
            </div>
			<div class="form-group mb-3 row">
                <label class="form-label col-3 col-form-label">UGR</label>
					<div class="col">
					  <input type="text" name="ugr_rating" id="ugr_rating" class="form-control" value="" placeholder="UGR RATTING" size=4 maxlength=5>
					</div>
            </div>
			...
			<div class="form-group mb-3 row">
				<label class="control-label col-lg-3"><b>Product Image(s)</b></label>
					<div class="col-lg-12">
			...
			<!--<div class="form-group mb-3 row">
				<label class="control-label col-lg-3"><b>Dimension Image(s)</b></label>
					<div class="col-lg-12">
								  <input type="file" class="form-control" name='files[]' multiple required />
								  <i style="color:red">*Lampiran wajib diisi</i>
					</div>
			...
			<div class="form-group mb-3 row">
				<label class="control-label col-lg-3"><b>Photometric</b></label>
					<div class="col-lg-12">
								  <input type="file" class="form-control" name='files[]' multiple required />
								  <i style="color:red">*Lampiran wajib diisi</i>
					</div>
