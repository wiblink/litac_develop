					...
					<thead>
						<tr style="background:#222;color:#f1f1f1;">
						  <th><b>NO.</b></th>
							...
							<th><b>lumen</b></th>
							<th><b>Colour</b></th>
							<th><b>Reflector Finish</b></th>
							<th><b>Accesories</b></th>
							<th><b>Action</b></th>
						</tr>
					</thead>
				</table>
				
                        <!--sebelumnya ada tabel statis disini-->
						 ...
						 if(!empty($cartlist)) {
                          ...
                          foreach ($cartlist as $baris) {
                            ...
                            <tr>
                              ...
                              <td><?php echo $baris->lamp; ?></td>
							  <td><?php echo $baris->name_product_brand; ?></td>
							  <td><?php echo $baris->power; ?></td>
							  <td><?php echo $baris->lumen; ?></td>
							  <td><?php echo $baris->name_product_colour; ?></td>
							  <td><?php echo $baris->name_ref_finish; ?></td>
							  <td><?php echo $baris->accesories; ?></td>
							  <td>
							   ...
							   <div class='col-6 col-sm-4 col-md-2 col-xl-auto mb-3'><a href="<?php echo base_url();?>catalog/inputcartcode?id=<?php echo $baris->idcart; ?><?php echo $idpar; ?>" data-toggle="tooltip" data-placement="top" title="Print Item" class="btn btn-primary w-100">Edit</a></div>
...
<!-- Memanggil jQuery data tables -->			  
		...
		function fill_search_datatable(tgl_start = '', tgl_end = '', project = '', location = '', status_project = '', note = '', user = '')
		  {
		   var dataTable = $('#mytable').DataTable({
			...
			ajax : {
			 ...
			 type:"POST",
			 data:{
			   tgl_start:tgl_start, tgl_end:tgl_end, project:project, location:location, status_project:status_project, note:note, user:user
			 }
			},
			orderCellsTop : false,
			fixedHeader   : false,
		...
		$('#btncari').click(function(e){
		  ...
		  e.preventDefault();
		   ...
		   if(tgl_start != '' || tgl_end != '' || project != '' || location != '' || status_project != '' || note != '' || user != '')
		   {
			$('#mytable').DataTable().destroy();
			fill_search_datatable(tgl_start, tgl_end, project, location, status_project, note, user);
		   }
		   else
		   {
