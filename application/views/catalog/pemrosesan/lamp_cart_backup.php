...
<!-- Memanggil jQuery data tables -->			  
		...
		function fill_search_datatable(code = '', codelamp = '', lamp = '', id_product_brand = '', power = '', lumen = '', product_colour = '', reflector_finish = '', accesories = '')
		  {
			...
			ajax : {
			 ...
			 type:"POST",
			 data:{
			   code:code, codelamp:codelamp, lamp:lamp, id_product_brand:id_product_brand, power:power, lumen:lumen, product_colour:product_colour, reflector_finish:reflector_finish, accesories:accesories
			 }
			},
			orderCellsTop : false,
			fixedHeader   : false,
		...
		//alert(accesories);
		  e.preventDefault();
		   ...
		   if(code != '' || codelamp != '' || lamp != '' || id_product_brand != '' || power != '' || lumen != '' || product_colour != '' || reflector_finish != '' || accesories != '')
		   {
			$('#mytable').DataTable().destroy();
			//alert(lamp);
			fill_search_datatable(code, codelamp, lamp, id_product_brand, power, lumen, product_colour, reflector_finish, accesories);
		   }
		   else
		   {
