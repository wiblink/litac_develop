           ...
           <div class="col-12">
			...
			<div class="form-group mb-3 row">
                <label class="form-label col-3 col-form-label">Tilt / Rotation (Deg)</label>
					<div class="col">
					  <input type="text" name="tilt" id="tilt" class="form-control numberdot" value="<?php echo $query->tilt; ?>" placeholder="Tilt" size=4 maxlength=6>
					</div>
					<div class="col">
					  <input type="text" name="rotation" id="rotation" class="form-control numberdot" value="<?php echo $query->rotation; ?>" placeholder="Rotation" size=4 maxlength=6>
					</div>
            </div>
			<hr>
			<!--<div class="form-group mb-3 row">
			...
			<div class="form-group mb-3 row">
                <label class="form-label col-3 col-form-label">Power (W)</label>
					<div class="col">
					  <input type="text" name="power" id="power" class="form-control numberdot" value="<?php echo $query->power; ?>" placeholder="Power" size=4 maxlength=6>
					</div>
            </div>
			<div class="form-group mb-3 row">
                <label class="form-label col-3 col-form-label">Voltage (V)</label>
					<div class="col">
					  <input type="text" name="voltage" id="voltage" class="form-control numberdot" value="<?php echo $query->voltage; ?>" placeholder="Voltage" size=4 maxlength=6>
					</div>
            </div>
			<div class="form-group mb-3 row">
                <label class="form-label col-3 col-form-label">Lumen (Lm)</label>
					<div class="col">
					  <input type="text" name="lumen" id="lumen" class="form-control numberdot" value="<?php echo $query->lumen; ?>" placeholder="Lumen" size=4 maxlength=6>
					</div>
            </div>
			<div class="form-group mb-3 row">
			...
			<div class="form-group mb-3 row" id="show-staticwhite" style="display:none;">
				<label class="form-label col-3 col-form-label"> </label>
					<div class="col">
						<input type="text" name="sw" id="sw" class="form-control numberdot" value="<?php echo $query->sw; ?>" size=4 maxlength=6>
					</div>
			</div>
			<div class="form-group mb-3 row">
                <label class="form-label col-3 col-form-label">CRI ></label>
					<div class="col">
					  <input type="text" name="cri" id="cri" class="form-control numberdot" value="<?php echo $query->cri; ?>" placeholder="CRI" size=4 maxlength=6>
					</div>
            </div>
			<div class="form-group mb-3 row">
			...
			<div class="form-group mb-3 row">
                <label class="form-label col-3 col-form-label">Diameter</label>
					<div class="col">
					  <input type="text" name="dim_diameter" id="dim_diameter" class="form-control numberdot" value="<?php echo $query->dim_diameter; ?>" placeholder="Diameter" size=4 maxlength=6>
					</div>
            </div>
			<div class="form-group mb-3 row">
                <label class="form-label col-3 col-form-label">Cut Out Diameter</label>
					<div class="col">
					  <input type="text" name="dim_cut_o_diameter" id="dim_cut_o_diameter" class="form-control numberdot" value="<?php echo $query->dim_cut_o_diameter; ?>" placeholder="Cut Out Diameter" size=4 maxlength=6>
					</div>
            </div>
			<div class="form-group mb-3 row">
			...
			<div class="form-group mb-3 row">
                <label class="form-label col-3 col-form-label">Height</label>
					<div class="col">
					  <input type="text" name="dim_height" id="dim_height" class="form-control numberdot" value="<?php echo $query->dim_height; ?>" placeholder="Height" size=4 maxlength=6>
					</div>
            </div>
			<div class="form-group mb-3 row">
                <label class="form-label col-3 col-form-label">Width</label>
					<div class="col">
					  <input type="text" name="dim_width" id="dim_width" class="form-control numberdot" value="<?php echo $query->dim_width; ?>" placeholder="Width" size=4 maxlength=6>
					</div>
            </div>
			<div class="form-group mb-3 row">
                <label class="form-label col-3 col-form-label">Length</label>
					<div class="col">
					  <input type="text" name="dim_length" id="dim_length" class="form-control numberdot" value="<?php echo $query->dim_length; ?>" placeholder="Length" size=4 maxlength=6>
					</div>
            </div>
			<div class="form-group mb-3 row">
                <label class="form-label col-3 col-form-label">Weight</label>
					<div class="col">
					  <input type="text" name="dim_weight" id="dim_weight" class="form-control numberdot" value="<?php echo $query->dim_weight; ?>" placeholder="Weight" size=4 maxlength=6>
					</div>
            </div>
			...
			<div class="form-group mb-3 row">
                <label class="form-label col-3 col-form-label">Recessed Depth</label>
					<div class="col">
					  <input type="text" name="dim_recc_depth" id="dim_recc_depth" class="form-control numberdot" value="<?php echo $query->dim_recc_depth; ?>" placeholder="Recessed Depth" size=4 maxlength=6>
					</div>
            </div>
			<div class="form-group mb-3 row">
                <label class="form-label col-3 col-form-label">Housing Depth</label>
					<div class="col">
					  <input type="text" name="dim_depth_housing" id="dim_depth_housing" class="form-control numberdot" value="<?php echo $query->dim_depth_housing; ?>" placeholder="Depth + Housing" size=4 maxlength=6>
					</div>
            </div>
			<hr>
			<div class="form-group mb-3 row">
			...
			<div class="form-group mb-3 row">
                <label class="form-label col-3 col-form-label">IP</label>
					<div class="col">
					  <input type="text" name="tecspec_ip" id="tecspec_ip" class="form-control numberdot" value="<?php echo $query->tecspec_ip; ?>" placeholder="IP" size=4 maxlength=6>
					</div>
            </div>
			<div class="form-group mb-3 row">
                <label class="form-label col-3 col-form-label">UGR</label>
					<div class="col">
					  <input type="text" name="ugr_rating" id="ugr_rating" class="form-control numberdot" value="<?php echo $query->ugr_rating; ?>" placeholder="UGR RATTING" size=4 maxlength=6>
					</div>
            </div>
