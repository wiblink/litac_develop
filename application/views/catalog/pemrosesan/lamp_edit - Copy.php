           ...
           <div class="col-12">
			...
			<div class="form-group mb-3 row">
				<label class="form-label col-3 col-form-label">Luminaire Type</label>
					<div class="col">
						<input type="text" name="luminaire_type" id="luminaire_type" class="form-control" value="<?php echo $query->luminaire_type; ?>" placeholder="Luminaire Type" required>
					</div>
			</div>			
			<div class="form-group mb-3 row">
			...
			<div class="form-group mb-3 row">
				<label class="form-label col-3 col-form-label">Luminaire Reference</label>
					<div class="col">
						<input type="text" name="luminaire_ref" id="luminaire_ref" class="form-control" value="<?php echo $query->luminaire_ref; ?>" placeholder="Luminaire Reference" required>
					</div>
			</div>
			<div class="form-group mb-3 row">
			...
			<div class="form-group mb-3 row">
                <label class="form-label col-3 col-form-label">Product Code</label>
					<div class="col">
					  <select class="form-control find_cd product_code" id="product_code" name="product_code">
				    	<option value="">No Selected</option>
				    </select>
					</div>
            </div>		
				...
				<label class="form-label col-3 col-form-label">Adjustable Optic</label>
					...
					&nbsp;
						<div class="form-check form-check-inline">
						  ...
						  <input class="form-check-input" name="adj_optic" type="checkbox" value="adj" id="adj" <?php if($query->adj_optic == '1'){echo "checked";} ?>>
						...
						<div class="form-check form-check-inline">
						  ...
						  <input class="form-check-input" name="nadj_optic" type="checkbox" value="nadj" id="nadj" <?php if($query->nadj_optic == '1'){echo "checked";} ?>>
			...
			<div class="form-group mb-3 row">
				<label class="form-label col-3 col-form-label">Product Control</label>
					<div class="col">
			...
			<div class="form-group mb-3 row">
                <label class="form-label col-3 col-form-label">Kelvin</label>
					<div class="col">
					  <input type="text" name="kelvin" id="kelvin" class="form-control" value="<?php echo $query->kelvin; ?>" placeholder="Kelvin" size=4 maxlength=5>
					</div>
            </div>
			<div class="form-group mb-3 row">
			...
			<div class="form-group mb-3 row">
                <label class="form-label col-3 col-form-label">Opening</label>
					<div class="col">
					  <input type="text" name="dim_opening" id="dim_opening" class="form-control" value="<?php echo $query->dim_opening; ?>" placeholder="Opening" size=4 maxlength=5>
					</div>
            </div>
			<div class="form-group mb-3 row">
			...
			<div class="form-group mb-3 row">
                <label class="form-label col-3 col-form-label">Cover height</label>
					<div class="col">
					  <input type="text" name="dim_cover_height" id="dim_cover_height" class="form-control" value="<?php echo $query->dim_cover_height; ?>" placeholder="Cover height" size=4 maxlength=5>
					</div>
            </div>		
			<div class="form-group mb-3 row">
                <label class="form-label col-3 col-form-label">Housing</label>
					<div class="col">
					  <input type="text" name="tecspec_housing" id="tecspec_housing" class="form-control" value="<?php echo $query->tecspec_housing; ?>" placeholder="Housing">
					</div>
            </div>
			<div class="form-group mb-3 row">
                <label class="form-label col-3 col-form-label">Reflector</label>
					<div class="col">
					  <input type="text" name="tecspec_reflector" id="tecspec_reflector" class="form-control" value="<?php echo $query->tecspec_reflector; ?>" placeholder="Reflector">
					</div>
            </div>
			<div class="form-group mb-3 row">
                <label class="form-label col-3 col-form-label">Lamp Holder</label>
					<div class="col">
					  <input type="text" name="tecspec_lamp_holder" id="tecspec_lamp_holder" class="form-control" value="<?php echo $query->tecspec_lamp_holder; ?>" placeholder="Lamp Holder">
					</div>
            </div>
			<div class="form-group mb-3 row">
			...
			<div class="form-group mb-3 row">
                <label class="form-label col-3 col-form-label">Adjustment</label>
					<div class="col">
					  <input type="text" name="tecspec_adjustment" id="tecspec_adjustment" class="form-control" value="<?php echo $query->tecspec_adjustment; ?>" placeholder="Adjustment">
					</div>
            </div>
			<div class="form-group mb-3 row">
                <label class="form-label col-3 col-form-label">Approval</label>
					<div class="col">
					  <input type="text" name="tecspec_approval" id="tecspec_approval" class="form-control" value="<?php echo $query->tecspec_approval; ?>" placeholder="Approval">
					</div>
            </div>
			<div class="form-group mb-3 row">
                <label class="form-label col-3 col-form-label">Transformer</label>
					<div class="col">
					  <input type="text" name="tecspec_transformer" id="tecspec_transformer" class="form-control" value="<?php echo $query->tecspec_transformer; ?>" placeholder="Transformer">
					</div>
            </div>
			<div class="form-group mb-3 row">
                <label class="form-label col-3 col-form-label">IP</label>
					<div class="col">
					  <input type="text" name="tecspec_ip" id="tecspec_ip" class="form-control" value="<?php echo $query->tecspec_ip; ?>" placeholder="IP">
					</div>
            </div>
			<div class="form-group mb-3 row">
                <label class="form-label col-3 col-form-label">UGR</label>
					<div class="col">
					  <input type="text" name="ugr_rating" id="ugr_rating" class="form-control" value="<?php echo $query->ugr_rating; ?>" placeholder="UGR RATTING">
					</div>
            </div>
			<div class="form-group mb-3 row">
