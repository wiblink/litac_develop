	...
	<table width="95%" style="border-collapse:collapse;margin-left:10pt;margin-top:10pt; margin-right:10pt;" cellspacing="0" border="0">
        ...
        <td>
			<table width="100%" cellspacing="0" border="0"  style="border: 1px solid;">
				...
				<tr>
					...
					<td class="s8" style="padding-left: 2pt;text-align: left;">:</td>
					<td class="s8" style="padding-left: 2pt;text-align: left;"><?php echo ($dt->revision ? $dt->revision : '0'); ?></td>
					<td class="s8" style="padding-left: 2pt;text-align: left;">&nbsp;</td>
				</tr>
			</table>
			<br>
        ...
        <td>
		  ...
		  ?></td>					
				...
				<tr>
					...
					<td class="s7">:</td>
					<td class="s7"><?php echo ($dt->name_optic_pdf ? $dt->name_optic_pdf : '-'); ?> <?php echo ($dt->beam_angle ? $dt->beam_angle : '-'); ?> &#176; <?php  // echo ($dt->ajust ? $dt->ajust : '-'); ?></td>
					<td class="s7">&nbsp;</td>
					<td class="s7"><?php echo ($dt->rotation ? $dt->rotation : '-'); ?></td>
					<td class="s7" ><b> &#176; / Rotation</td>
					<td class="s7">&nbsp;</td>
        ...
        <td>
			<table width="100%" cellspacing="0" border="0">
				...
				<tr>
					...
					<td class="s7">L : <?php echo ($dt->dim_length ? $dt->dim_length : '-'); ?>&nbsp; W : <?php echo ($dt->dim_width ? $dt->dim_width : '-'); ?> &nbsp;H : <?php echo ($dt->dim_height ? $dt->dim_height : '-'); ?></td>
					<td class="s7"></td>
					<td class="s7"></td>
					...
					<td class="s7">&nbsp;</td>
					<td class="s7">&nbsp;</td>
					<td class="s7">Weight : <?php echo ($dt->dim_weight ? $dt->dim_weight : '-'); ?> Kg</td>					
					<td>&nbsp;</td>
				</tr>
			</table>
        </td>
	  ...
	  <tr  style="height:15pt">
        <td>
			<table width="100%" cellspacing="0" border="0" >
				<tr>
					<td style="padding-left: 2pt;"><h1>PHOTOMETRIC</h1></td>					
				</tr>
				<tr>
					<td><BR>
