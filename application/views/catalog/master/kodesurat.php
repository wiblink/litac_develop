              ...
              <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                 ...
                 if ($userData['kewenangan'] == 'admin') { ?>
                    <br>
                    <a href="kodesurat/t" class="btn btn-primary d-none d-sm-inline-block">
...
<!-- Memanggil jQuery data tables -->			  
		...
		function fill_datatable()
		{
			...
			ajax       : {
				method : "GET",
				url  : "<?php echo base_url('ketatausahaan/kodesurat_json') ?>",
				data : data => {
					// Read values
	...
	function eAlert(x){
		...
		.then((willDelete) => {
			if (willDelete) {
				swal("Sukses! Kode Surat berhasil dihapus.", {
					icon: "success"
				});
				window.location.href = '../ketatausahaan/kodesurat/h/'+ x +'';
			} else {
				swal("Kode Surat batal dihapus");
			}
		});
	}
