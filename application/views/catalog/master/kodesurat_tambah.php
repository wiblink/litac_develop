              ...
              <div class="card">
				...
				<div class="card-body">
			      ...
			      <div class="form-group mb-3 row">
                    ...
                    <div class="col">
                      <input type="text" name="no_kode" class="form-control" value="" placeholder="Nomor Kode" required>
                    </div>
                  </div>
				  ...
				  <div class="form-group mb-3 row">
                    ...
                    <div class="col">
                      <input type="text" name="nama_kode" class="form-control" value="" placeholder="Klasifikasi/Nama Kode" required>
                    </div>
                  </div>
				  ...
				  <div class="form-group mb-3 row">
                    ...
                    <div class="col">
					  <textarea class="form-control" id="desc_kode" name="desc_kode" rows="4" cols="50" placeholder="Deskripsi"></textarea>
                    </div>
                  </div>                          
                      </div>
                    </div>
