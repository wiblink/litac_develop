            ...
            <div class="col-lg-8">
			  ...
			  <div class="card-body">
				...
				<div class="form-group mb-3 row">
                  ...
                  <div class="col">
                    <input type="text" name="username" class="form-control" placeholder="" maxlength="100" required>
                  </div>
                </div>
                <div class="form-group mb-3 row">
                  <label class="form-label col-3 col-form-label">Nama Lengkap</label>
                  <div class="col">
                    <input type="text" name="nama_lengkap" class="form-control" placeholder="" maxlength="100" required>
                  </div>
                </div>
                <div class="form-group mb-3 row">
				...
				<div class="form-group mb-3 row">
                  ...
                  <div class="col">
							<div class="input-icon">
									...
									<input type="text" name="tanggal_lahir" class="form-control" id="tanggal_lahir" value="" maxlength="10" required placeholder="Masukkan Tanggal">
							</div>
                  </div>
                </div>
				<div class="form-group mb-3 row">
                    ...
                    <select class="form-control cari_gol" name="golongan_id" id="golongan_id" required>
                              ...
                              <?php
                                    ...
                                    foreach ($golongan as $baris) { ?>
                                        <option value="<?php echo $baris->id; ?>"><?php echo $baris->golongan; ?></option>
									<?php } }?>
                    </select>
                  </div>
                </div>
                    ...
                    <select class="form-control cari_jabatan" name="id_jabatan_organisasi" id="id_jabatan_organisasi" required>
                              ...
                              <?php
                                    ...
                                    foreach ($jabatan_organisasi as $baris) { ?>
                                        <option value="<?php echo $baris->id; ?>"><?php echo $baris->jabatan; ?></option>
									<?php } }?>
                    </select>
                  </div>
                </div>
                    ...
                    <select class="form-control cari_kewenangan" name="kewenangan_id" id="kewenangan_id" required>
                              ...
                              <?php
                                    ...
                                    foreach ($ref_kewenangan as $baris) { ?>
                                        <option value="<?php echo $baris->id; ?>"><?php echo $baris->kewenangan; ?></option>
									<?php } }?>
                    </select>
                  </div>
                </div>
