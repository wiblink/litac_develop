              ...
              <div class="card">
				...
				<div class="card-body">
			      ...
			      <div class="form-group mb-3 row">
                    ...
                    <div class="col">
                      <input type="text" name="jenis_surat" class="form-control" value="" placeholder="Jenis Surat" required>
                    </div>
                  </div>
				  <div class="form-group mb-3 row">
                    <label class="form-label col-3 col-form-label">Deskripsi</label>
                    <div class="col">
					  <input type="text" name="desc" class="form-control" value="" rows="4" cols="50" placeholder="Deskripsi" required>
                    </div>
                  </div>                          
                      </div>
                    </div>
