            ...
            <div class="row align-items-center">
              ...
              <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                  ...
                  <a href="user/t" class="btn btn-primary d-none d-sm-inline-block">
	...
	function fill_datatable()
		{
			...
			ajax       : {
				method : "GET",
				url  : "<?php echo base_url('catalog/user_json') ?>",
				data : data => {
					// Read values
		...
		function fill_search_datatable(tgl_start = '', tgl_end = '', jenis = '')
		  {
		   ...
		   var dataTable = $('#usertable').DataTable({
			...
			//"order" : [],
			ajax : {
			 url  : "<?php echo base_url('catalog/search_imagearchives_json') ?>",
			 type:"POST",
			 data:{
	...
	function eAlert(x){
		...
		.then((willDelete) => {
			if (willDelete) {
				...
				window.location.href = '../catalog/user/h/'+ x +'';
			} else {
