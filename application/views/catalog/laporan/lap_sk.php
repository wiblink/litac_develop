        ...
        ?>
          <div class="panel-body">
            <fieldset class="content-group">
              <legend class="text-bold"><i class="fa fa-print" aria-hidden="true"></i> Laporan Surat Keluar</legend>
              <form class="form-inline" action="" method="post">
                ...
                <button type="submit" name="data_lap" class="btn btn-primary">Submit</button>
              </form>
            </fieldset>
          </div>
