...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <body>
	...
	<table width="100%" style="border-collapse:collapse;margin-left:10pt;margin-top:10pt; margin-right:10pt;" cellspacing="0" border="0">
	  ...
	  <tr style="height:10pt">
        <td>
			<table width="100%" cellspacing="0" border="0"  style="border: 1px solid;">
				<tr>
					<td class="s7" style="padding-left: 2pt;"><h1>PROJECT</td>
					<td class="s7">:</td>
					<td class="s7" colspan="8" style="padding-left: 2pt;text-align: left;"><?php echo $dt->project; ?></td>
					<td class="s4" style="text-align: center; border-left: 1px solid;"><h1>CODE</td>
				</tr>
				<tr>
					<td class="s7" style="padding-left: 2pt;"><h1>AREA</td>
					<td class="s7">:</td>
					<td class="s7" colspan="8" style="padding-left: 2pt;text-align: left;"><?php echo $dt->location; ?></td>
					<td rowspan='2' class="s4" style="text-align: center; border-left: 1px solid;"><?php echo $dt->codelamp; ?></td>
				</tr>
				<tr>
					<td class="s7" style="padding-left: 2pt;"><h1>DATE</td>
					<td class="s7">:</td>
					<td class="s7" style="padding-left: 2pt;text-align: left;"><?php echo date('d-m-Y',strtotime($dt->tanggal_project)); ?></td>
					<td class="s7" style="padding-left: 2pt;text-align: left;"><h1>STATUS</td>
					<td class="s7" style="padding-left: 2pt;text-align: left;">:</td>
					<td class="s7" style="padding-left: 2pt;text-align: left;"><?php echo $dt->status_project; ?></td>
					<td class="s7" style="padding-left: 2pt;text-align: left;"><h1>REVISION</td>
					<td class="s7" style="padding-left: 2pt;text-align: left;">:</td>
					<td class="s7" style="padding-left: 2pt;text-align: left;">1</td>
					<td class="s7" style="padding-left: 2pt;text-align: left;">&nbsp;</td>
				</tr>
			</table>
			<br>
        ...
        <td>
		  ...
		  ?></td>					
				...
				<tr>
					...
					<td class="s7" style="border-right: 1px solid;"><h1>LM</td>
					<td class="s7">&nbsp;</td>
					<td class="s7">&nbsp;</td>
					<td class="s7"><?php echo ($dt->voltage ? $dt->voltage : '-'); ?></td>
					<td colspan="3" class="s7"><h1>V</td>
				</tr>
				<tr>
					...
					<td class="s7" style="border-right: 1px solid;"><h1>CRI</td>
					<td class="s7">&nbsp;</td>
					<td class="s7">&nbsp;</td>
					<td class="s7">12</td>
					<td colspan="3" class="s7"><h1>UGR</td>
				</tr>
				<tr>
					<td class="s7" style="padding-left: 2pt; padding-bottom: 2pt;">Accessories</td>
					<td class="s7">:</td>
					<td class="s7"><?php echo ($dt->accesories ? $dt->accesories : '-'); ?></td>
					<td class="s7">&nbsp;</td>
					<td class="s7">&nbsp;</td>
					<td class="s7" ><h1>DEG</td>
					<td class="s7">&nbsp;</td>
					<td style="border-left: 1px solid;" class="s7">&nbsp;</td>
					<td class="s7" ><?php echo ($dt->tilt ? $dt->tilt : '-'); ?></td>
					<td class="s7" style="border-right: 1px solid;"><h1>T</td>
					<td class="s7">&nbsp;</td>
					<td class="s7">&nbsp;</td>
					<td class="s7"><?php echo ($dt->rotation ? $dt->rotation : '-'); ?></td>
					<td colspan="3" class="s7"><h1>R</td>
				</tr>				
				<tr>
					<td class="s7" style="padding-left: 2pt; padding-bottom: 2pt;">Adjustable Optic</td>
					<td class="s7">:</td>
					<td colspan="14" class="s7"><?php echo ($dt->ajust ? $dt->ajust : '-'); ?><?php //echo ($dt->name_optic ? $dt->name_optic : '-'); ?></td>
				</tr>
				<tr>
					<td class="s7" style="padding-left: 2pt;">Code NR</td>
					<td class="s7">:</td>
					<td colspan="14" class="s7"><?php echo ($dt->projnr ? $dt->projnr : '-'); ?></td>					
				</tr>				
			...
			<table width="100%" cellspacing="0" border="0" >
				...
				<tr>
					...
					<?php
						...
						echo "<img src='lampiran/".$baris->nama_berkas."' width='140'>&nbsp;";
							}
						} else {
							echo "<img src='assets/img/noimage.jpg' width='100'>&nbsp;";
						}
					?>					
					<?php
	  ...
	  <tr style="height:10pt">
        <td>
			<table width="100%" cellspacing="0" border="0">
				<tr>
					<td style="padding-left: 2pt;" colspan="15"><h1>DIMENSION</h1></td>					
				</tr>
				<tr>
        ...
        <td>
			<table width="100%" cellspacing="2" border="0">
				...
				<tr>
					...
					<td class="s7" rowspan="8" style="border-left: 1px solid;">&nbsp;</td>
					<td  class="s7">Driver IP</td>
					<td colspan="5" class="s7"><?php echo ($dt->driver_ip ? $dt->driver_ip : '-'); ?></td>	
					<td class="s7" rowspan="7" style="border-left: 1px solid;">&nbsp;</td>					
				</tr>
				<tr>
					<td class="s7" style="padding-left: 2pt;"></td>
					<td class="s7">&nbsp;</td>
